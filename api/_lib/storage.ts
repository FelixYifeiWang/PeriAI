...
export interface IStorage {
  ...
  updateCampaignStatus(id: string, status: "processing" | "waiting_approval" | "finished" | "denied"): Promise<Campaign>;
...
export class DatabaseStorage implements IStorage {
  ...
  async updateCampaignStatus(id: string, status: "processing" | "waiting_approval" | "finished" | "denied"): Promise<Campaign> {
    const [result] = await db
      .update(campaigns)
